...
public class MazeProblem {
     ...
     * Note: in general, should be specified by a source state and action,
     * but in the MazeProblem, only the destination state (parameter) matters.
    ...
    public int[] testSolution (ArrayList<String> possibleSoln) {
        ...
        if (possibleSoln == null) { return result; }
