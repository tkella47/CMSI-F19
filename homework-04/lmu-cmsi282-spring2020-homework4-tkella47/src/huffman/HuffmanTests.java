...
public class HuffmanTests {
    ...
    @Test
    public void comp_t4() {
        Huffman h = new Huffman("CODED");
      
        byte[] compressed = {5, -35,0};
       
        assertArrayEquals(compressed, h.compress("CODED"));
    } 
    @Test
    public void comp_t5() {
        Huffman h = new Huffman("SURROUND");
        // byte 0: 0000 0010 = 2 (message length = 2)
        // byte 1: 0100 0000 = 64 (0 = "A", 1 = "B")
        // [!] Only first 2 bits of byte 1 are meaningful
        byte[] compressed = {8, 88,62,-64};
        
        assertArrayEquals(compressed, h.compress("SURROUND"));
    }
    ...
    public void decom_t5() {
        ...
        assertEquals("CODED", h.decompress(compressed));
    } 
    @Test
    public void decom_t6() {
        ...
        assertEquals("SURROUND", h.decompress(compressed));
    }
